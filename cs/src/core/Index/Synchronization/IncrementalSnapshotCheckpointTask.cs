...
{
    /// <summary>
    /// An incremental Snapshot persists a version by making a copy for every changed entry of that version 
    /// separate from the log. It is slower and more complex than a foldover or full snapshot, but more 
    /// space-efficient on the log, and retains in-place update performance as it does not advance 
    /// the readonly marker unnecessarily.
    /// </summary>
    internal class IncrementalSnapshotCheckpointTask : HybridLogCheckpointOrchestrationTask
    {
        /// <inheritdoc />
